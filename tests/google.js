...
module.exports = {
  ...
  'Demo test Google' : function (client) {
    ...
    client.expect.element('#hplogo').text.to.match(/Казахстан/).before(1000);

    client.setValue('#lst-ib', 'Казахстан').pause(500);
    client.expect.element('#lst-ib').to.have.value.equal('Казахстан');
